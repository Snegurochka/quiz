<template>
  <div class="wrapper">
    <div class="bg"></div>
    <div class="animated animated--1"></div>
    <div class="animated--logo animated--logo1">
      <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fab"
    ...
    <div class="animated--logo animated--logo2">
      <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fab"
...
.animated {
  ...
  animation: anima1 3s 1.5s infinite ease-in-out;
}
